...
def copy_source(source_dir, dest_dir, exclude_patterns=None):
    ...
    default_exclude_files = {".DS_Store", ".gitignore", ".gitmodules", "*.pyc", "*.pyo", "run_live_graduation.sh", "run_stage8_live_smoke.sh", "WORKER_E_REPORT.md"}
...
def main():
    ...
    print(f"Version: {__version__} (commit {commit_sha[:8]})")

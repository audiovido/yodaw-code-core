...
Environment always wins over the file. Secrets live in
environment variables (never the file and never logs); the file
only names the variable via `api_key_env`.
"""
